...
#	spawn_trash(find_child(dancers_spawned[selected_dancer], false, false), trash_standard)
		# this has been moved to world script
...
func on_trashing(trash_type):
	animation_sprite.play("drop_item_" + returned_direction(get_last_motion()))
